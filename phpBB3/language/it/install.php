...
$lang = array_merge($lang, array(
	...
	'INSTALL_CONGRATS_EXPLAIN'		=> '
		...
		<p>Cliccando sul pulsante sottostante accederai ad un modulo del tuo Panello di Controllo Amministratore (PCA) che ti permetterà di inviare informazioni di carattere statistico a phpBB. Ti saremo grati se vorrai aiutarci inviandoci queste semplici informazioni. Dopo questo, ti consigliamo di dedicare un po’ di tempo per esaminare le opzioni disponibili. Ricorda che è disponibile un aiuto OnLine tramite la <a href="https://www.phpbb.com/support/docs/en/3.1/ug/">Documentazione</a> e anche presso i <a href="https://www.phpbb.com/community/viewforum.php?f=466">Forum di Supporto</a>, <a href="%3$s">LEGGI</a> per ulteriori informazioni.</p><p><strong>Adesso cancella, sposta o rinomina la cartella "install" prima di usare la Board. Se la cartella è ancora presente potrai accedere solo al Pannello di Controllo Amministratore (PCA).</strong>',
