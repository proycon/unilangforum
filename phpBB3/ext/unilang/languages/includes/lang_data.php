...
class lang_data {
    ...
    */
    ...
    'kva' => "Bagvalal",
    'ace' => "Basa Acèh",
    'ms' => array("Bahasa Melayu", "-O" => "Malayu Kuna"),
    'mzn' => "مازندرانی",
    'ba' => "Башҡортса",
    'ban' => "Basa Bali",
    'bgx' => 'Rumeli Türkçesi',
    ...
    'bm' => "Bambara",
    'bn' => "বাংলা",
    'bo' => array("བོད་སྐད་", '-S' => "བོད་སྐད་", '-C' => "དབུས་གཙང་སྐད་", '-ADX' => "ཨ་མདོ་སྐད",'-KHD' => "ཁམས་སྐད་", '-BOD' => "བོད་སྐད་"),    
    'kac' => "Jingpho",
    'kap' => "бежкьалас миц",
    'blc' => "Bella Coola",
    'br' => "Brezhoneg",
    ...
    'co' => "Corsu",
    'cop' => "ⲙⲛⲧⲣⲙⲛⲕⲏⲙⲉ",
    'kw' => array("Kernewek",'-OLD' => 'Old Cornish'),   
    'cv' => "чӑваш чӗлхи",
    'cy' => array('Cymraeg', '-OLD' => "Old Welsh"),    
    'da' => "Dansk",
    'dak' => "Dakȟótiyapi",
    'dlc' => "Dalska",
    'dar' => "дарган мез",
    ...
    'fur' => "Furlan",
    'ga' => array('Gaeilge', '-M' => 'Gaelainn na Mumhan', '-C' => 'Gaeilge Connacht', '-U' => 'Gaeilg Uladh', '-SGA' => 'Goídelc', '-PMT' => 'Primitive Irish'),
    'gv' => "Gaelg",
    'gag' => "Gagauz dili",
    'gd' => "Gàidhlig",
   ...
   //'ja' => array("日本語", '.clas' => '和文', '-ho' => '北海道弁', '-to' => '東北弁', '-ka'=> '関東弁', '-kan' => '関西弁', '-ha' => '博多弁'),
    ...
    'sgn' => array("Sign language", "-AU" => 'Auslan', "-US" => 'American Sign Language',"-GB" => 'British Sign Language',"-EE" => 'Estonian Sign Language',"-CY" => 'Κυπριακή Νοηματική Γλώσσα',"-GR" => 'GSL',"-IE" => 'Irish Sign Language','-CN' => '中国手语', '-DE' => 'DGS',"-FR" => 'LSF', "-CA-QC" => 'LSQ', '-ES' => 'LSE', '-BR' => 'LIBRAS', '-IT' => 'LIS', "-NL" => 'NGT','-JP' => '日本手話', "-PT" => 'Língua Gestual Portuguesa', '-NO' => 'NSL',"-CA-QC" => 'LSQ','-RU' => 'РЖЯ','-RS' => 'Српски знаковни језик','-IL' => "שפת סימנים ישראלית",'-SE' => 'TSP', "-TR" => 'Türk İşaret Dili', "-UA" => 'УЖМ',
           "-AT" => "Österreichische Gebärdensprache (ÖGS)", "-PL" => "Polski język migowy (PJM)", "-HU" => "Magyar Jelnyelv", "-RO" => "Limbajul semnelor română", "-BG" => " български жестомимичен език (БЖЕ)", "-ID" => "BISINDO"),
    ...
    'te' => "తెలుగు",
    'din' => "Thuɔŋjäŋ",
    'vi' => array("Tiếng Việt", "-S" => "Tiếng Việt (Giọng Miền Nam)"),
    'tin' => "Tindi",
    'tlh' => 'tlhIngan-Hol',
    'tli' => "Lingít",
    'ti' => "ትግርኛ",
    ...
    'zu' => "isiZulu",
    'zun' => "Zuni",
    'art' => array("Constructed Language",'-ido' => 'Ido', '-ina' => 'Interlingua', '-jbo' => 'Lojban', '-lfn' => 'Lingua Franca Nova', '-nov' => 'Novial', '-sjn' => 'Sindarin', '-tlh' => 'tlhIngan-Hol','-tkp' => 'Toki Pona', '-qya' => 'Quenya','-srs' => 'Solresol', '-vo' => 'Volapük', '-avk' => 'Kotava', '-ldn' => 'Láadan', '-tzl' => 'Talossan','-bzt' => 'Brithenig'),
    'wbl' => 'X̌ik zik',
    'ane' => "Xârâcùù",
    'bal' => "بلوچی‎",
    'cha' => "Cha'cña",
    ...
    'txb' => "Kuchean",
    'xht' => "Hattic",
    'luw' => array('Luwian', '-XLU' => "Cuneiform Luwian", '-HLU' => "Hieroglyphic Luwian"),
    'xld' => "Lydian",
    'xlc' => "Lycian",
    'xhy' => "Hurrian",
    'xur' => "Urartian",
    ...
    'xno' => 'Anglo-Norman',
    'apw' => 'Western Apache',
    'ar' => array('Arabic', '-SA' => "Saudi Arabian Arabic", '-DZ' => "Algerian Arabic", '-acy' => 'Cypriot Maronite Arabic', '-afb' => 'Gulf Arabic', '-EG' => "Egyptian Arabic", '-MA' => "Moroccan Arabic", '-apc' => 'Levantine Arabic', '-LB' => "Lebanese Arabic", '-LY' => "Libyan Arabic", '-IQ' => "Iraqi Arabic", '-SD' => "Sudanese Arabic", '-TN' => "Tunisian Arabic", '-arb' => "Standard Arabic", '-SY' => "Syrian Arabic", '-JO' => "Jordanian Arabic", '-PA' => "Palestinian Arabic", '-AE' => "Emirati Arabic", '-QA' => "Qatari Arabic", '-BH' => "Bahraini Arabic", '-KW' => "Kuwaiti Arabic", '-OM' => "Omani Arabic", '-YE' => "Yemeni Arabic"),
    'an' => 'Aragonese',
    'arc' => 'Aramaic',
    'arp' => 'Arapaho',
    'arw' => 'Arawak',
    'aqc' => 'Archi',
    'ari' => 'Arikara',
    'hy' => array('Armenian', '-E' => "Eastern Armenian", '-W' => "Western Armenian", '-H' => "Homshetsi Armenian", '_mid' => "Middle Armenian", '_clas' => "Classical Armenian"),
    'rup' => 'Aromanian',
    'aer' => 'Arrernte',
    'as' => 'Assamese',
    'ast' => 'Asturian',
    ...
    'ny' => 'Chewa',
    'chy' => 'Cheyenne',
    'yue' => array('Cantonese Chinese','.Hans' => 'Cantonese [Simplified script]', '.Hant' => 'Cantonese [Traditional script]'),
    'zhc' => 'Classical Chinese',
    'gan' => array('Gan Chinese', '.Hans' => 'Gan Chinese [Simplified script]', '.Hant' => 'Gan Chinese [Traditional script]'),
    'hak' => array('Hakka Chinese','.Hans' => "Hakka [Simplified script]",'.Hant' => "Hakka [Traditional script]"),
    ...
    'cim' => 'Cimbrian',
    'cop' => 'Coptic',
    'kw' => array("Cornish",'-OLD' => 'Old Cornish'),
    'co' => 'Corsican',
    'cr' => 'Cree',
    'crg' => "Michif",
    ...
    'dnj' => 'Dan',
    'dua' => 'Duala',
    'nl' => array("Dutch",'-BE' => 'Flemish','_nbr' => "Brabantian Dutch",'_mid' => 'Middelnederlands'), //_mid = dum),
    'dz' => 'Dzongkha',
    'egy' => 'Ancient Egyptian',
    'elx' => 'Elamite',
    'egl' => 'Emiliano',
    ...
    'iu' => 'Inuktitut',
    'ipk' => 'Iñupiaq',
    'ga' =>  array('Irish', '-M' => 'Munster Irish', '-C' => 'Connacht Irish', '-U' => 'Ulster Irish', '-SGA' => 'Old Irish', '-PMT' => 'Primitive Irish' ),
    'it' => 'Italian',
    'itl' => 'Itelmen',
    'jmk' => 'Jamtlandic',
    ...
    'pih' => 'Norfuk/Pitkern',
    'frr' => "North Frisian",
    'no' => array("Norwegian",'-nn' => 'Nynorsk Norwegian','-nb' => 'Bokmål Norwegian','-val' => 'Vallemål Norwegian'), /* no-val is an ad-hoc code*/
    'blc' => 'Nuxálk',
    'oc' => 'Occitan',
    'oj' => 'Ojibwe',
    'ono' => "Onondaga",
    ...
    'or' => 'Oriya',
    'om' => 'Oromoo',
    'os' => array("Iron Ossetic",'-Digor' => 'Digor Ossetic'), /* os-Iron and os-Digor are ad-hoc codes*/
    'osa' => "Osage",
    'oia' => "Oirata",
    'pau' => 'Palauan',
    'pi' => 'Pali',
    ...
    'hsb' => 'Upper Sorbian',
    'st' => 'Sotho',
    'es' => array("Spanish",'-ES' => 'European Spanish', '-MX' => 'Mexican Spanish', '-AR' => 'Argentinian Spanish','-CL' => 'Chilean Spanish','-PE' => 'Peruvian Spanish','-VE' => 'Venezuelan Spanish', '-CO' => 'Colombian Spanish', '-BO' => 'Bolivian Spanish', '-PY' => 'Paraguayan Spanish', '-UY' => 'Uruguayan Spanish', '-CU' => 'Cuban Spanish', '-DO' => 'Dominican Spanish', '-PA' => 'Panamanian Spanish','-CR' => 'Costa Rican Spanish','-HN' => 'Honduran Spanish', '-NI' => 'Nicaraguan Spanish', '_old' => "Old Spanish", '-SV' => "Salvadoran Spanish", '-GT' => "Guatemalan Spanish",'-PR' => "Puerto Rican Spanish", '-AN' => 'Andalusian Spanish', '-EC' => 'Ecuadorian Spanish' ),
    'srn' => 'Sranan Tongo',
    'su' => 'Sundanese',
    'sux' => 'Sumerian',
    'sva' => 'Svan',
    ...
    'tly' => 'Talysh',
    'taq' => 'Tamasheq',
    'ta' => array('Tamil','-LK' => 'Sri Lankan Tamil'),
    'ttt' => 'Tat',
    'tt' => 'Tatar',
    'tsg' => 'Tausug',
    'tkl' => "Tokelauan",
    ...
    'tem' => "Temne",
    'th' => 'Thai',
    'bo' => array('Tibetan', '-S' => "Standard Tibetan", '-C' => "Central Tibetan", '-ADX' => "Amdo Tibetan",'-KHD' => "Khams Tibetan", '-BOD' => "Classical Tibetan"),
    'kac' => "Jingpho",
    'ti' => 'Tigrinya',
    'tli' => 'Tlingit',
    'tin' => 'Tindi',
    ...
    'vec' => 'Venetian',
    'vep' => 'Veps',
    'vi' => array('Vietnamese', "-S" => "Southern Vietnamese"),
    'vro' => 'Voro',
    'vot' => 'Votic',
    'prk' => 'Wa',
    'wls' => 'Wallisian',
    ...
    'zu' => 'Zulu',
    'zun' => 'Zuni',
    'art' => array("Constructed Language",'-ido' => 'Ido', '-ina' => 'Interlingua', '-tlh' => 'Klingon', '-lfn' => 'Lingua Franca Nova', '-nov' => 'Novial', '-jbo' => 'Lojban' ,'-sjn' => 'Sindarin','-tkp' => 'Toki Pona', '-qya' => 'Quenya','-srs' => 'Solresol','-vo' => 'Volapuk',  '-avk' => 'Kotava', '-ldn' => 'Láadan', '-tzl' => 'Talossan','-bzt' => 'Brithenig'),
    'bci' => 'Baoulé',
    'wbl' => "Wakhi",
    'ane' => "Xârâcùù",
    'bal' => "Balochi",
